...
public class PlOllamaAPI {
     ...
     *
     * @param model Name of the model to use, make sure to pull the model first.
     * @param prompt The prompt... dun, dun, dun...
     * @return The response generated by Ollama
     * @throws OllamaBaseException If there is an error from the Ollama API
     * @throws IOException If an I/O error occurs
     * @throws InterruptedException If the thread is interrupted
     */
    public String makeRequest(String model, String prompt) throws OllamaBaseException, IOException, InterruptedException {

        // Make the API request
        String response = String.valueOf(ask(model, prompt));
